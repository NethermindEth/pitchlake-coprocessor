...
use simulate_price_verify_position_floating_mock::simulate_price_verify_position_mock;
use simulate_price_verify_position_floating_mock_methods::SIMULATE_PRICE_VERIFY_POSITION_FLOATING_MOCK_GUEST_ID;
...
fn main() {
    ...
    let (receipt, _simulate_price_res) = simulate_price_verify_position_mock(input);

    receipt
        .verify(SIMULATE_PRICE_VERIFY_POSITION_FLOATING_MOCK_GUEST_ID)
        .unwrap();
